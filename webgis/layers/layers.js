...
jsonSource_kecamatanjepara_2.addFeatures(features_kecamatanjepara_2);var lyr_kecamatanjepara_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/kecamatanjepara_2_5.png" />  630.0 - 2000.0 <br />'
        });var format_Nelayan_3 = new ol.format.GeoJSON();
var features_Nelayan_3 = format_Nelayan_3.readFeatures(json_Nelayan_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Nelayan_3 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_Nelayan_3.addFeatures(features_Nelayan_3);var lyr_Nelayan_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Nelayan_3, 
                style: style_Nelayan_3,
                title: '<img src="styles/legend/Nelayan_3.png" /> Nelayan'
            });

lyr_OSMStandard_0.setVisible(true);lyr_KABUPATENJEPARA_1.setVisible(true);lyr_kecamatanjepara_2.setVisible(true);lyr_Nelayan_3.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_KABUPATENJEPARA_1,lyr_kecamatanjepara_2,lyr_Nelayan_3];
...
lyr_Nelayan_3.set('fieldAliases', {'id': 'id', 'Kecamatan': 'Kecamatan', 'Nelayan': 'Nelayan', });
...
lyr_Nelayan_3.set('fieldImages', {'id': 'TextEdit', 'Kecamatan': 'TextEdit', 'Nelayan': 'TextEdit', });
...
lyr_Nelayan_3.set('fieldLabels', {'id': 'inline label', 'Kecamatan': 'inline label', 'Nelayan': 'inline label', });
lyr_Nelayan_3.on('precompose', function(evt) {
