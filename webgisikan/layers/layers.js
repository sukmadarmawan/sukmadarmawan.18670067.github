...
jsonSource_kecamatanjepara_2.addFeatures(features_kecamatanjepara_2);var lyr_kecamatanjepara_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/kecamatanjepara_2_0.png" />  0.00 - 2811.00 <br />\
    <img src="styles/legend/kecamatanjepara_2_1.png" />  2811.00 - 5620.00 <br />\
    <img src="styles/legend/kecamatanjepara_2_2.png" />  5620.00 - 6771.00 <br />\
    <img src="styles/legend/kecamatanjepara_2_3.png" />  6771.00 - 22105.00 <br />\
    <img src="styles/legend/kecamatanjepara_2_4.png" />  22105.00 - 769435.00 <br />\
    <img src="styles/legend/kecamatanjepara_2_5.png" />  769435.00 - 769440.00 <br />'
        });var format_ikan_3 = new ol.format.GeoJSON();
var features_ikan_3 = format_ikan_3.readFeatures(json_ikan_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ikan_3 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_ikan_3.addFeatures(features_ikan_3);var lyr_ikan_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_ikan_3, 
                style: style_ikan_3,
                title: '<img src="styles/legend/ikan_3.png" /> ikan'
            });

lyr_OSMStandard_0.setVisible(true);lyr_KABUPATENJEPARA_1.setVisible(true);lyr_kecamatanjepara_2.setVisible(true);lyr_ikan_3.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_KABUPATENJEPARA_1,lyr_kecamatanjepara_2,lyr_ikan_3];
...
lyr_ikan_3.set('fieldAliases', {'id': 'id', 'Kecamtan': 'Kecamtan', 'Jml Ikan': 'Jml Ikan', });
...
lyr_ikan_3.set('fieldImages', {'id': 'TextEdit', 'Kecamtan': 'TextEdit', 'Jml Ikan': 'TextEdit', });
...
lyr_kecamatanjepara_2.set('fieldLabels', {'ID': 'no label', 'ID_Kec': 'no label', 'Kecamatan': 'inline label', 'xcoord': 'no label', 'ycoord': 'no label', 'kode_prop': 'no label', 'kode_kab': 'no label', 'Jml_nelaya': 'no label', 'kapal': 'no label', 'ikan': 'inline label', });
lyr_ikan_3.set('fieldLabels', {'id': 'inline label', 'Kecamtan': 'inline label', 'Jml Ikan': 'inline label', });
lyr_ikan_3.on('precompose', function(evt) {
